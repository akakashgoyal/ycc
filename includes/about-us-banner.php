                            ...
                            <div class="section__title">
                                ...
                                <h2 class="title">
                                    ...
                                    <span class="position-relative">
                                        ...
                                        Youth Coaching Centre
                                    </span>

                                </h2>
                            </div>
                            <p class="desc">Our comprehensive platform simplifies learning, making it easy for students to access, organize, and prioritize their studies. Stay ahead with our cutting-edge educational resources.</p>
                            <ul class="about__info-list list-wrap">
                                <li class="about__info-list-item">
                                    <i class="flaticon-angle-right"></i>
                                    <p class="content">Learn from Top Educators and Subject Experts</p>
                                </li>
                                <li class="about__info-list-item">
                                    <i class="flaticon-angle-right"></i>
                                    <p class="content">Learn Anytime, Anywhere</p>
                                </li>
                                <li class="about__info-list-item">
                                    <i class="flaticon-angle-right"></i>
                                    <p class="content">Tailored Learning Paths for Every Student</p>
                                </li>
                            </ul>
                            <div class="tg-button-wrap">
                                <a href="about-us.html" class="btn arrow-btn">Know more <img src="assets/img/icons/right_arrow.svg" alt="img" class="injectable"></a>
                            </div>
                        </div>
                    </div>
                </div>
