...
<head>
    <title>Home - Youth Coaching Center</title>
...
<body>
    ...
    <main class="main-area fix">
                    ...
                    <div class="col-xl-5 col-lg-6">
                        <div class="banner__content">
                            ...
                            <div class="banner__btn-wrap" data-aos="fade-right" data-aos-delay="800">
                                <a href="contact.html" class="btn arrow-btn">Looking For Home Tuition <img src="assets/img/icons/right_arrow.svg" alt="img" class="injectable"></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="categories__item">
                                            <a href="courses.html">
                                                ...
                                                <span class="name">Class 1 to 5</span>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="categories__item">
                                            <a href="courses.html">
                                                ...
                                                <span class="name">Class 6 to 8</span>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="categories__item">
                                            <a href="courses.html">
                                                ...
                                                <span class="name">Class 9 to 12</span>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="categories__item">
                                            <a href="courses.html">
                                                <div class="icon">
                                                    <img src="assets/images/test.png" alt="" style="width: 64px; height: 64px; "">
                                                </div>
                                                <span class=" name">Competitive Exams</span>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="categories__item">
                                            <a href="courses.html">
                                                ...
                                                <span class="name">Home Tuitions</span>
        ...
        <!-- about-area -->
        <?php include('includes/about-us-banner.php') ?>
        <!-- about-area-end -->
                    ...
                    <div class="col-xl-4">
                        <div class="instructor__content-wrap">
                            <div class="section__title mb-15">
                                ...
                                <h2 class="title">Meet Our Top Educators: Experts in Every Subject, All in One Place</h2>
                            </div>
                            <p>Discover our exceptional team of educators who bring years of expertise and passion to their teaching. Each instructor is a specialist in their field, dedicated to providing top-quality education across various subjects. Whether you're preparing for exams or seeking in-depth knowledge, our expert instructors are here to guide you every step of the way.</p>
                            <div class="tg-button-wrap">
                                <a href="instructors.html" class="btn arrow-btn">See All Faculties <img src="assets/img/icons/right_arrow.svg" alt="img" class="injectable"></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-8">
            ...
            <div class="container">
                <div class="fact__inner-wrap">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="fact__item">
                                <h2 class="count"><span class="odometer" data-count="8000">0</span>+</h2>
                                <p>Active Students</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="faq__content">
                            <div class="section__title pb-10">
                                ...
                                <h2 class="title">Start Learning From <br> World’s Pro Instructors <br>at Youth Coaching Center</h2>
                            </div>
                                ...
                                <div class="accordion" id="accordionExample">
                                    <div class="accordion-item">
                                        <h2 class="accordion-header">
                                            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne"
                                                ...
                                                What subjects do you offer coaching in?
                                            </button>
                                        </h2>
                                        <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                <p>We offer comprehensive coaching in a wide range of academic subjects including Mathematics, Science, English, Social Studies, and more. Our programs are tailored to meet the needs of students from elementary to high school levels.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                <p>Our instructors are highly qualified with degrees and professional experience in their respective fields. They are dedicated to providing top-notch academic support and use proven teaching methods to ensure student success.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                <p>Students have access to a variety of resources including textbooks, practice exercises, online materials, and mock tests. We also provide guidance on study techniques and exam preparation to enhance their learning experience.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        <h2 class="accordion-header">
                                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                                ...
                                                How do you ensure the quality of your coaching?
                                            </button>
                                        </h2>
                                        <div id="collapseFour" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                <p>We ensure the quality of our coaching through regular evaluations, feedback from students and parents, and continuous professional development for our instructors. Our aim is to provide effective and high-quality education to help students excel.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
        ...
        <!-- features-area -->
        <?php include('includes/journey.php') ?>
                        ...
                        <div class="col-xl-6">
                            <div class="instructor__item-two tg-svg">
                                ...
                                <div class="instructor__content-two">
                                    <h3 class="title"><a href="contact.html">Become an Instructor</a></h3>
                                    <p> We are looking for passionate individuals who are experts in their fields and committed to helping students achieve their academic goals.</p>
                                    <div class="tg-button-wrap">
                                        <a href="contact.html" class="btn arrow-btn">Apply Now <img src="assets/img/icons/right_arrow.svg" alt="Apply Now" class="injectable"></a>
                                    </div>
                                </div>
                            </div>
                        </div>
